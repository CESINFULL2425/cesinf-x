    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h-50 w-50 rounded-full flex items-center justify-center text-white font-bold text-4xl">
            <div className="absolute w-full h-full bg-black/[0.8] blur-xl rounded-full" />
...
export function CardPattern({ mouseX, mouseY, randomString, purpleFlow }: any) {
